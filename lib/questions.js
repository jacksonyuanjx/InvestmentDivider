...
const questions = {
    ...
    tickerSymbolQuesDuplicate: {
        type: "input",
        name: "ticker_symbol",
        message: `${underline().red("Ticker already added.")} Provide a different one (or type 'q' if you're done entering): `,
    },
    tickerSymbolQuesEmptyStr: {
        type: "input",
        name: "ticker_symbol",
        message: `${underline().red("Ticker cannot be empty.")} Provide the ticker of one of the investments (or type 'q' if you're done entering): `,
    },
};
